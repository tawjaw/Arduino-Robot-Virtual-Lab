...
require("./arduino-ide-container-element");
require("./monaco-editor-element");
let ArduinoIDE = class ArduinoIDE extends lit_element_1.LitElement {
    constructor() {
        super(...arguments);
        this.status = 'off';
        this.value = '';
...
ArduinoIDE = __decorate([
    lit_element_1.customElement('p4-arduino-ide')
], ArduinoIDE);
exports.ArduinoIDE = ArduinoIDE;
/*
<link
        rel="stylesheet"
