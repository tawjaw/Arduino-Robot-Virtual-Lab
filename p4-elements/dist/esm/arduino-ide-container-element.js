...
let ArduinoIDEContainer = class ArduinoIDEContainer extends LitElement {
    constructor() {
        super(...arguments);
        this.status = 'off';
      ...
      <div class="cards-container">
        <div class="card-header">
          ${this.status === 'compiling'
            ...
            : html ``}
          ${this.status === 'on'
            ? html `<div class="time-label" id="status-label">
...
ArduinoIDEContainer = __decorate([
    customElement('p4-arduino-ide-container')
], ArduinoIDEContainer);
export { ArduinoIDEContainer };
